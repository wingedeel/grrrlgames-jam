var StateGameOver={    
   ...
   preload:function()
    ...
    create:function()
    {
        ...
        this.btnStartAgain = game.add.button(
       		game.world.centerX,
       ...
       this.btnStartAgain.anchor.set(0.5, 0.5);
       this.btnStartAgain.bringToTop();

       // CONGRATS TEXT
       this.titleText = game.add.text(game.world.centerX, 245, "Game Over !",
          { font: "100px Lobster", 
            fill: "#FFFFFF", 
            stroke:"#C02FD5",
            strokeThickness: 4,
